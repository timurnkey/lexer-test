...
// sha3: 2d4a3b04452c1c456af35152d5f77105a784af7b487ceaeb693064a70f7fec76
...
mod __parse__Expr {
    ...
    ) -> Option<Result<Box<Expr>,__lalrpop_util::ParseError<usize, Token<'input>, &'static str>>>
    {
        let (__pop_states, __nonterminal) = match __action {
            ...
            5 => {
                ...
                let __nt = match super::__action1::<>(input, __sym0, __sym1, __sym2, __sym3) {
                    Ok(v) => v,
    ...
    {
        // WithCommas<Expr> = Expr => ActionFn(20);
        let __sym0 = __pop_Variant1(__symbols);
        let __start = __sym0.0.clone();
        let __end = __sym0.2.clone();
    ...
    {
        // WithCommas<Expr> = (<Expr> ",")+, Expr => ActionFn(22);
        assert!(__symbols.len() >= 2);
        let __sym1 = __pop_Variant1(__symbols);
        let __sym0 = __pop_Variant2(__symbols);
        let __start = __sym0.0.clone();
    ...
    {
        // WithCommas<Expr> = (<Expr> ",")+ => ActionFn(23);
        let __sym0 = __pop_Variant2(__symbols);
        let __start = __sym0.0.clone();
        let __end = __sym0.2.clone();
